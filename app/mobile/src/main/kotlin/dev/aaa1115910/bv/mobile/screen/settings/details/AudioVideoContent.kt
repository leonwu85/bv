...
fun AudioVideoContent(
    ...
    val kernelState = rememberPlayerKernelState(onPlayerTypeChanged)
    ...
    LazyColumn(
        ...
        preferenceGroups(
            "播放器" to {
                playerKernelPreferences(context = context, state = kernelState, includeVlcOptions = true)
            },
            "\u5c4f\u5e55\u65b9\u5411" to {
                switchPreference(
                    title = "\u968f\u8bbe\u5907\u503e\u659c\u81ea\u52a8\u8fdb\u5165\u5168\u5c4f",
