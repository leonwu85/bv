...
enum class VideoPlayerDanmakuMenuItem(private val strRes: Int) {
    ...
    Merge(R.string.video_player_menu_danmaku_merge),
    FilterLevel(R.string.video_player_menu_danmaku_filter_level),
    SpeedMode(R.string.video_player_menu_danmaku_speed_mode),
    PresentationSpeed(R.string.video_player_menu_danmaku_presentation_speed);
